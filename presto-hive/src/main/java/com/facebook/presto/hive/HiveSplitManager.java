        ...
        implements ConnectorSplitManager
{
            ...
            SplitSchedulingContext splitSchedulingContext)
    {
        ...
        Iterable<HivePartitionMetadata> hivePartitions = getPartitionMetadata(metastore, table, tableName, partitions, hiveBucketProperty, session, layout.getRequestedColumns());
